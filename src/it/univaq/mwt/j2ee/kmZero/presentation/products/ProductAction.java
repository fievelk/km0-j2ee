...
/*		form.setDate_in(DateConversionUtility.calendarDateToString(product.getDate_in()));
		form.setDate_out(DateConversionUtility.calendarDateToString(product.getDate_out()));*/
